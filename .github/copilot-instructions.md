...
- [x] Clarify Project Requirements (Done: Python + UI + simple solver)
	<!-- Ask for project type, language, and frameworks if not specified. Skip if already provided. -->

- [x] Scaffold the Project (Done: directories and base files created)
	<!--
...
- [x] Customize the Project (Done: SLP + optimization + UI modules)
	<!--
